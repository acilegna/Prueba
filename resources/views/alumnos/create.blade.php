...
@section('content')
    <div class="container-fluid">
        ...
        <h3 class="title-Alumno">Registro Alumnos</h3>
        <form action="{{ route('saveStudents') }}" method="POST" id="altaAlumnos">
            {{ csrf_field() }}
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputControl">No Control</label>
                    <input type="text" class="form-control" id="inputControl" name="inputControl" required>
                </div>
                <div class="form-group col-md-6">
